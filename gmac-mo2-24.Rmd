...
plot_i <- slope_corr_comp %>% 
  ...
  scale_colour_manual(values = c("#f692B4", "#6E7889", "#53af8b")) +
...
# Combine plots in pages of 6 (2 columns x 3 rows)
plots_per_page <- 6
...
for (i in seq_len(n_pages)) {
  ...
  page_plots <- patchwork::wrap_plots(plot_list[start:end], ncol = 2)
  print(page_plots)
}
```
...
## MENTION R vaules with text from MS
