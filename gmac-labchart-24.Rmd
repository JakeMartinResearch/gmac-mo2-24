...
For those fish that were best modelled with a 2^nd^ or 3^rd^-order polynomial (*n* = 38) we will check to see if a Pcrit is present. We are filtering the data for only those fish.   
